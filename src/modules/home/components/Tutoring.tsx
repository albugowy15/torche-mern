...
function BenefitBox({ title, desc, Icon }: { title: string; desc: string; Icon: any }) {
	return (
		<div className="rounded-xl flex flex-col gap-1 p-6 text-center items-center bg-[#0b122a]">
...
export default function Tutoring() {
	return (
		<section className="py-16 px-3 bg-[#121d42] text-white">
			<h2 className="font-bold text-center text-4xl">Kenapa tutoring bareng Torche</h2>
			...
			<div className="grid grid-cols-2 grid-rows-2 gap-4 my-7">
